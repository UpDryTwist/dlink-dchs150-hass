...
async def test_successful_config_flow(hass, bypass_get_data, config_entry):
    ...
    result = await hass.config_entries.flow.async_configure(
        result["flow_id"], user_input=config_entry
    )
...
async def test_failed_config_flow(hass, error_on_get_data, config_data):
...
async def test_options_flow(hass, config_entry, config_options):
    ...
    result = await hass.config_entries.options.async_configure(
        result["flow_id"], user_input=config_options
    )
