...
COPY --chown=${USER}:${GROUP} --chmod=0755 src/dlink_dschs150_hass    /app/dlink_dschs150_hass
...
ENV PYTHONUNBUFFERED=1 \
    ...
    PYTHONPATH=/app \
    LOGFILE=/logs/dlink_dschs150_hass.log

# TODO:
#    CONFIGFILE=/config/dlink_dschs150_hass.yaml \
